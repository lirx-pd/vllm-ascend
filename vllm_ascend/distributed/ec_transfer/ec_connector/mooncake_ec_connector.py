...
from vllm_ascend.distributed.ec_transfer.ec_connector.mooncake.scheduler import (
    ECMooncakeScheduler,
)
from vllm_ascend.distributed.ec_transfer.ec_connector.mooncake.worker import ECMooncakeWorker
...
class ECMooncakeConnector(ECConnectorBase):
    ...
    def ensure_cache_available(
        ...
        assert self._scheduler is not None
        return self._scheduler.ensure_cache_available(request, num_computed_tokens, local_cache_hashes)
